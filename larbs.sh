...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/annata83/arch_Tilling"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/annata83/arch_Tilling/master/progs.csv"
