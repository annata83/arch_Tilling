...
# DEFAULTS:
[ -z "$dotfilesrepo" ] && dotfilesrepo="https://github.com/annata83/Arch_rice"
[ -z "$progsfile" ] && progsfile="https://raw.githubusercontent.com/annata83/Arch_rice/master/progs.csv"
